import { User, Vehicle, Rental } from './types'
...
export const rentals: Rental[] = [
  ...
  // Rental 4: Due 2 days ago (past active)
  {
    id: 'rental-004',
    userId: 'user-004',
    vehicleId: 'veh-003',
  ...
  // Rental 5: Due 1 day ago (past active)
  {
    id: 'rental-005',
    userId: 'user-005',
    vehicleId: 'veh-005',
    startAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000), // 2 days ago
    dueAt: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000), // 1 day ago
    returnedAt: null,
    status: 'active',
    totalBill: 80000,
    totalPaid: 50000, // Partial payment
  },
